...
class TemperaturaServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ListarTemperaturas = channel.unary_unary(
                '/TemperaturaService/ListarTemperaturas',
                request_serializer=temperatura__pb2.Empty.SerializeToString,
...
def add_TemperaturaServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListarTemperaturas': grpc.unary_unary_rpc_method_handler(
                    servicer.ListarTemperaturas,
                    request_deserializer=temperatura__pb2.Empty.FromString,
                    response_serializer=temperatura__pb2.TemperaturasResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'TemperaturaService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('TemperaturaService', rpc_method_handlers)
...
class TemperaturaService(object):
    ...
    @staticmethod
    def ListarTemperaturas(request,
            target,
            options=(),
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/TemperaturaService/ListarTemperaturas',
            temperatura__pb2.Empty.SerializeToString,
